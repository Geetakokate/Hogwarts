...
defineFeature(feature, test => {
	...
	test('Horace Slughorn is allocated to Harry Potter for Potions Master', ({ given, when, and, then }) => {
	...
	test('No teacher is allocated to Harry Potter for Potions Master', ({ given, when, and, then }) => {
	...
	test('Horace Slughorn is allocated to Harry Potter but he is absent', ({ given, when, and, then }) => {
		given('Harry is studying from Rubeus Hagrid', () => {
	...
	test('Horace Slughorn is allocated to Harry Potter for Potions Master. But Horace and standby teacher is absent', ({ given, when, and, then }) => {
	...
	test('Horace Slughorn is allocated to Harry Potter. He was absent but he is present now', ({ given, when, then }) => {
