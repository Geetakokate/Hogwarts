...
import { getTeachersList, updateTeacherAttendance } from '../actionCreators/attendanceActionCreators';
...
const ScheduleToday = () => {
	...
	<Card className="m-2">
		...
		<CardBody>
			<Row>
				<Col>
					<TeachersList teachersList={teachersList} onAttendanceChange={onAttendanceChange} />
				</Col>
				<Col>
